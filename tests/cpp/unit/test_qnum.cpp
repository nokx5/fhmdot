...
BOOST_AUTO_TEST_CASE(unittest_qnum_sh) {
  BOOST_CHECK(quantum_number_crtp<sh_none>::dimension == 1);
  BOOST_CHECK(quantum_number_crtp<sh_none>::sum(2, 3) == 0);
  BOOST_CHECK(quantum_number_crtp<sh_none>::sum(7, 2) == 0);

  BOOST_CHECK(quantum_number_crtp<sh_u1>::dimension == 2);
  ...
  BOOST_CHECK(quantum_number_crtp<sh_su2>::dimension == 1);
